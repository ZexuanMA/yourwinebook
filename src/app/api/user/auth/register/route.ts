...
import { registerUser, verifyUserCredentials } from "@/lib/mock-users";
...
export async function POST(request: NextRequest) {
  ...
  const loggedIn = verifyUserCredentials(email, "demo123"); // mock: registerUser sets password to demo123
  void loggedIn;
