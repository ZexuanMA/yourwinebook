  ...
  return (
    <div className="space-y-7">
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        <div>
          <h1 className="text-xl sm:text-2xl font-semibold text-text">流量分析</h1>
...
function MerchantAnalytics() {
  ...
  return (
    <div className="space-y-7">
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        <div>
          <h1 className="text-xl sm:text-2xl font-semibold text-text">{t("mAnalytics.title")}</h1>
          ...
          <table className="w-full text-sm min-w-[500px]">
            <thead>
              <tr className="bg-bg border-b border-wine-border">
                ...
                <th className="text-right px-4 sm:px-6 py-3.5 text-xs font-semibold text-text-sub uppercase tracking-wider">{t("mAnalytics.rate")}</th>
              </tr>
            </thead>
        ...
        {loading ? (
          ...
          <table className="w-full text-sm min-w-[480px]">
            <thead><tr className="bg-bg border-b border-wine-border">
              <th className="text-left px-4 sm:px-6 py-3 text-xs font-semibold text-text-sub uppercase tracking-wider">{t("table.wine")}</th>
              <th className="text-left px-4 py-3 text-xs font-semibold text-text-sub uppercase tracking-wider">Session</th>
              <th className="text-right px-4 sm:px-6 py-3 text-xs font-semibold text-text-sub uppercase tracking-wider">{t("mAnalytics.time")}</th>
            </tr></thead>
            <tbody className="divide-y divide-[#F5F0EA]">
              {data.recentClicks.map((c, i) => (
                <tr key={i} className="hover:bg-bg transition-colors">
                  ...
                  <td className="px-4 sm:px-6 py-3.5 text-right text-text-sub text-xs">{new Date(c.timestamp).toLocaleTimeString("zh-HK")}</td>
                </tr>
              ))}
            </tbody>
          </table>
